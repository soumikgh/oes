...
echo '<div class="resultBody"><h2><font color="green">Congratulations!</font> You have completed the test.</h2>';
...
echo "You have scored :<strong> " . (5 - count($incorrect)) . " out of 5.</strong><br /><br />";
...
if(count($incorrect) > 0)
{
	...
	foreach($incorrect as $key => $value)
	{
		...
		echo '<strong><font color="#C00">Q)</font></strong><span class="inc_ques">' . $result['q_body'] . '</span>';
...
echo '<br /><h4 align="center">Thank you for using our test system</h3></div>';
